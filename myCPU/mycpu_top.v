...
/*.............信号定义..........................*/
    ...
    wire [31:0] csr_rvalue;     // CSR读出值（地址=wb_csr_addr，→WB级，供CSR指令写回rd）

    // [新增] EXE 级 CSR 读口：按 EXE 级指令自己的地址读，供其计算 csr_wdata（修正读地址bug）
    wire [11:0] exe_csr_addr;   // EXE 级 CSR 地址（来自 exe_stage）
    wire [31:0] exe_csr_rvalue; // CSR[exe_csr_addr]（来自 csr_regfile，→EXE级）
...
/*.............模块实例化..........................*/
  ...
  exe_stage  exe_stage (
      ...
      // [新增] CSR读值：按 EXE 级自己的地址读出（修正原先误用 wb_csr_addr 的 bug）
  ...
  csr_regfile  u_csr_regfile (
    ...
    .csr_rvalue   (csr_rvalue    ),
    // [新增] EXE 级 CSR 读口（按 exe_csr_addr 读，供 EXE 计算 csr_wdata）
